...
const DIMENSION_DETAILS: Record<DimensionKey, Record<Level, DimensionDetail>> =
  {
    activity: {
      high: {
        description:
...
const PAID_STRENGTHS: Record<PrimaryType, StrengthItem[]> = {
  ...
  socializer: [
    ...
    {
      title: '감정을 나누는 표현력',
      description: '자신의 기분이나 생각을 말로 표현하는 데 비교적 능숙할 수 있어요.',
    },
  ],
  observer: [
    {
  ...
  observer: [
    {
      ...
      description: '시끄럽거나 복잡한 환경 후에는 충분한 회복 시간이 필요합니다.',
    },
    {
  ...
  balanced: [
    {
      ...
      description: '다양한 활동을 시도하며 아이가 더 반짝이는 영역을 찾아 주세요.',
    },
    {
