  ...
  return (
    <div className="flex flex-col bg-white pb-[var(--bottom-nav-space)] px-6">
      ...
      <article className="py-6 text-[14px] font-normal leading-relaxed space-y-6" style={{ color: palette.gray500 }}>
        ...
        <section>
          <h2 className="text-[14px] font-medium mb-[10px]" style={{ color: palette.black }}>제2조 (정의)</h2>
        ...
        <section>
          <h2 className="text-[14px] font-medium mb-[10px]" style={{ color: palette.black }}>제3조 (약관의 효력 및 변경)</h2>
          <ol className="list-decimal pl-5 space-y-1">
        ...
        <section>
          <h2 className="text-[14px] font-medium mb-[10px]" style={{ color: palette.black }}>제6조 (유료 서비스 및 결제)</h2>
          <ol className="list-decimal pl-5 space-y-1">
        ...
        <section>
          <h2 className="text-[14px] font-medium mb-[10px]" style={{ color: palette.black }}>제7조 (회원의 의무)</h2>
          <ol className="list-decimal pl-5 space-y-1">
        ...
        <section>
          <h2 className="text-[14px] font-medium mb-[10px]" style={{ color: palette.black }}>제8조 (서비스 이용 제한)</h2>
          <p>
        ...
        <section>
          <h2 className="text-[14px] font-medium mb-[10px]" style={{ color: palette.black }}>제9조 (계약 해지 및 탈퇴)</h2>
          <ol className="list-decimal pl-5 space-y-1">
        ...
        <section>
          <h2 className="text-[14px] font-medium mb-[10px]" style={{ color: palette.black }}>제10조 (면책조항)</h2>
          <ol className="list-decimal pl-5 space-y-1">
        ...
        <section>
          <h2 className="text-[14px] font-medium mb-[10px]" style={{ color: palette.black }}>제11조 (분쟁 해결 및 준거법)</h2>
          <ol className="list-decimal pl-5 space-y-1">
        ...
        <section className="pt-4 border-t border-gray-200">
          <p className="text-[12px] font-normal" style={{ color: palette.gray500 }}>부칙: 본 약관은 2026년 4월 8일부터 시행됩니다.</p>
        </section>
      </article>
    </div>
  );
