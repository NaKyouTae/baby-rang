    ...
    const renderMarkers = () => {
      ...
      cells.forEach((cell) => {
        ...
        const cluster = new naver.maps.Marker({
          ...
          map,
          icon: {
            content: `<div style="width:${size}px;height:${size}px;display:flex;align-items:center;justify-content:center;background:rgba(48,120,201,0.6);color:#fff;font-weight:700;font-size:12px;border:1px solid #3078C9;border-radius:9999px;">${count}</div>`,
    ...
    <div className="flex flex-col h-dvh bg-gray-50">
      ...
      <div className="flex-1 relative isolate">
        ...
        {selectedRoom && (
          ...
          >
            <div className="overflow-y-auto p-[10px] flex flex-col gap-1">
              {/* 헤더: 종류 뱃지 + 닫기 */}
              <div className="flex items-center gap-1.5 h-4">
              ...
              {/* 추가 설명 */}
              {selectedRoom.notes && (
                <div className="p-2.5 rounded-xl bg-gray-50 text-[12px] text-gray-600 leading-relaxed whitespace-pre-wrap">
                  {selectedRoom.notes}
                </div>
              )}
