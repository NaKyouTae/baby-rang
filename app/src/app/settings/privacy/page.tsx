  ...
  return (
    <div className="flex flex-col bg-white" style={{ paddingBottom: 'calc(var(--safe-area-bottom) + 96px)' }}>
      ...
      <article className="px-5 pt-6 pb-[41px] text-[14px] font-normal leading-relaxed space-y-6" style={{ color: palette.gray500 }}>
        ...
        <section>
          <h2 className="text-[14px] font-medium mb-[10px]" style={{ color: palette.black }}>4. 개인정보의 제3자 제공</h2>
          <p>
        ...
        <section>
          <h2 className="text-[14px] font-medium mb-[10px]" style={{ color: palette.black }}>5. 개인정보 처리 위탁</h2>
        ...
        <section>
          <h2 className="text-[14px] font-medium mb-[10px]" style={{ color: palette.black }}>6. 개인정보의 파기 절차 및 방법</h2>
          <ol className="list-decimal pl-5 space-y-1">
        ...
        <section>
          <h2 className="text-[14px] font-medium mb-[10px]" style={{ color: palette.black }}>7. 회원의 권리 및 행사 방법</h2>
          <ol className="list-decimal pl-5 space-y-1">
        ...
        <section>
          <h2 className="text-[14px] font-medium mb-[10px]" style={{ color: palette.black }}>8. 개인정보의 안전성 확보 조치</h2>
          <ol className="list-decimal pl-5 space-y-1">
        ...
        <section>
          <h2 className="text-[14px] font-medium mb-[10px]" style={{ color: palette.black }}>9. 쿠키 및 유사 기술의 사용</h2>
          <p>
        ...
        <section>
          <h2 className="text-[14px] font-medium mb-[10px]" style={{ color: palette.black }}>10. 개인정보 보호책임자</h2>
          <p>
        ...
        <section>
          <h2 className="text-[14px] font-medium mb-[10px]" style={{ color: palette.black }}>11. 권익 침해 구제 방법</h2>
        ...
        <section>
          <h2 className="text-[14px] font-medium mb-[10px]" style={{ color: palette.black }}>12. 개인정보처리방침의 변경</h2>
          <p>
      ...
      {isAuthenticated && <ConsentToggleBar consentKey="privacy" />}
    </div>
  );
}
