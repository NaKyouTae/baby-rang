      ...
      },
      {
        ...
        icon: (
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
            ...
            <path d="M4.66659 9.99998C5.77116 9.99998 6.66659 9.10455 6.66659 7.99998C6.66659 6.89541 5.77116 5.99998 4.66659 5.99998C3.56202 5.99998 2.66659 6.89541 2.66659 7.99998C2.66659 9.10455 3.56202 9.99998 4.66659 9.99998Z" stroke="black"/>
            <path d="M11.3333 14.6666C12.4379 14.6666 13.3333 13.7712 13.3333 12.6666C13.3333 11.562 12.4379 10.6666 11.3333 10.6666C10.2287 10.6666 9.33325 11.562 9.33325 12.6666C9.33325 13.7712 10.2287 14.6666 11.3333 14.6666Z" stroke="black"/>
            <path d="M9.66659 4.33331L6.33325 6.99998M9.66659 11.6666L6.33325 8.99998" stroke="black" strokeLinecap="round"/>
          </svg>
        ),
      },
      {
        ...
        icon: (
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
            ...
            <path d="M6.33325 12.6666V13C6.33325 13.4421 6.50885 13.866 6.82141 14.1785C7.13397 14.4911 7.55789 14.6666 7.99992 14.6666C8.44195 14.6666 8.86587 14.4911 9.17843 14.1785C9.49099 13.866 9.66659 13.4421 9.66659 13V12.6666" stroke="black" strokeLinecap="round"/>
          </svg>
        ),
      },
    ],
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              <path fillRule="evenodd" clipRule="evenodd" d="M10.0002 2.70833C10.1659 2.70833 10.3249 2.77418 10.4421 2.89139C10.5593 3.0086 10.6252 3.16757 10.6252 3.33333V9.37499H16.6668C16.8326 9.37499 16.9916 9.44084 17.1088 9.55805C17.226 9.67526 17.2918 9.83423 17.2918 9.99999C17.2918 10.1658 17.226 10.3247 17.1088 10.4419C16.9916 10.5591 16.8326 10.625 16.6668 10.625H10.6252V16.6667C10.6252 16.8324 10.5593 16.9914 10.4421 17.1086C10.3249 17.2258 10.1659 17.2917 10.0002 17.2917C9.8344 17.2917 9.67543 17.2258 9.55822 17.1086C9.44101 16.9914 9.37516 16.8324 9.37516 16.6667V10.625H3.3335C3.16774 10.625 3.00876 10.5591 2.89155 10.4419C2.77434 10.3247 2.7085 10.1658 2.7085 9.99999C2.7085 9.83423 2.77434 9.67526 2.89155 9.55805C3.00876 9.44084 3.16774 9.37499 3.3335 9.37499H9.37516V3.33333C9.37516 3.16757 9.44101 3.0086 9.55822 2.89139C9.67543 2.77418 9.8344 2.70833 10.0002 2.70833Z" fill="#BBC0C5"/>
            </svg>
          </Link>
        </div>
